...
const MinimalNav: React.FC = () => {
  ...
  const handleOverlayKeyDown = (event: React.KeyboardEvent, closeHandler: () => void) => {
    ...
    <>
        ...
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <Link to="/" className="flex items-center transition-opacity hover:opacity-80">
              <img 
                src={isDarkMode 
                  ? "https://leznqfezoofngumpiqf.supabase.co/storage/v1/object/sign/biowelllogos/Biowell_Logo_Dark_Theme.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV82ZjcyOGVhMS1jMTdjLTQ2MTYtOWFlYS1mZmI3MmEyM2U5Y2EiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJiaW93ZWxsbG9nb3MvQmlvd2VsbF9Mb2dvX0RhcmtfVGhlbWUuc3ZnIiwiaWF0IjoxNzUyNjYzNDE4LCJleHAiOjE3ODQxOTk0MTh9.itsGbwX4PiR9BYMO_jRyHY1KOGkDFiF-krdk2vW7cBE"
                  : "https://leznqfezoofngumpiqf.supabase.co/storage/v1/object/sign/biowelllogos/Biowell_logo_light_theme.svg?token=eyJraWQiOiJzdG9yYWdlLXVybC1zaWduaW5nLWtleV82ZjcyOGVhMS1jMTdjLTQ2MTYtOWFlYS1mZmI3MmEyM2U5Y2EiLCJhbGciOiJIUzI1NiJ9.eyJ1cmwiOiJiaW93ZWxsbG9nb3MvQmlvd2VsbF9sb2dvX2xpZ2h0X3RoZW1lLnN2ZyIsImlhdCI6MTc1MjY2MzQ0NiwiZXhwIjoxNzg0MTk5NDQ2fQ.gypGnDpYXvYFyGCKWfeyCrH4fYBGEcNOKurPfcbUcWY"
                }
                alt="Biowell" 
                  ...
                  {showThemeMenu && (
                    <>
                      <button 
                        ...
                        onKeyDown={(e) => handleOverlayKeyDown(e, () => setShowThemeMenu(false))}
                      />
                      <motion.div
                    ...
                    {showUserMenu && (
                      <>
                        <button 
                          ...
                          onKeyDown={(e) => handleOverlayKeyDown(e, () => setShowUserMenu(false))}
                        />
                        <motion.div
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <>
            <motion.button
              className="fixed inset-0 z-40 bg-black/30 backdrop-blur-md lg:hidden border-0"
              aria-label="Close mobile menu"
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              onClick={() => setIsMobileMenuOpen(false)}
              onKeyDown={(e) => handleOverlayKeyDown(e, () => setIsMobileMenuOpen(false))}
            />
            <motion.div
