  ...
  const fetchSupplement = async (supplementId: string) => {
    ...
    try {
      ...
      if (data) {
        ...
        let parsedBenefits;
        if (data.benefits) {
          parsedBenefits = typeof data.benefits === 'string' ? data.benefits.split(',') : data.benefits;
        } else {
          parsedBenefits = generateMockBenefits(data.name);
        }
        
        // Parse certifications from string if needed
        let parsedCertifications;
        if (data.certifications) {
          parsedCertifications = typeof data.certifications === 'string' ? data.certifications.split(',') : data.certifications;
        } else {
          parsedCertifications = ['Third-party tested', 'GMP certified', 'Non-GMO'];
        }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-8">
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                {supplement.evidence_summary && (
                  <div className="mt-4 mb-6">
                    ...
                    <div className={`p-4 rounded-lg ${getTierStyling(supplement.tier)}`}>
              ...
              <div className="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                ...
                <div className="flex items-center mb-4">
                  <label htmlFor="quantity" className="text-gray-700 dark:text-gray-300 mr-3">Quantity:</label>
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    {supplement.benefits?.map((benefit, index) => (
                      <li key={`benefit-${benefit}-${index}`} className="flex items-start">
